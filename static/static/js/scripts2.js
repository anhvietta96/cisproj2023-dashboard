...
var sidebar = document.getElementById("grid-container")
console.log("This is a test")
function openSidebar() {
    if(!sidebarOpen)
        sidebar.classList.remove("grid-container-responsive")
        sidebar.classList.add("grid-container");
        sidebarOpen = true;
}

function closeSidebar() {
    if(sidebarOpen)
        sidebar.classList.remove("grid-container");
        sidebar.classList.add("grid-container-responsive")
        sidebarOpen = false;
}
